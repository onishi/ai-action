...
function loadStage(stageIndex) {
    ...
    for (let i = 0; i < gateCount; i++) {
        ...
        phaseGates.push(
            { id: `SOLID_GATE_${i}_A`, phase: 'SOLID', x: baseX - 100, y: 470, width: 42, height: 70, link: `SOLID_GATE_${i}_B`, cooldown: 0 },
            { id: `SOLID_GATE_${i}_B`, phase: 'SOLID', x: baseX + 600, y: 220, width: 42, height: 70, link: `SOLID_GATE_${i}_A`, cooldown: 0 },
            { id: `ETHER_GATE_${i}_A`, phase: 'ETHER', x: baseX - 80, y: 440, width: 48, height: 72, link: `ETHER_GATE_${i}_B`, cooldown: 0 },
            { id: `ETHER_GATE_${i}_B`, phase: 'ETHER', x: baseX + 550, y: 210, width: 48, height: 72, link: `ETHER_GATE_${i}_A`, cooldown: 0 }
        );
    }
