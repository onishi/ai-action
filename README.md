...
### ステージシステム（v0.9, v0.18, v0.20, v0.21で調整）
- **6つのステージ**（各ステージで移動速度を段階的に変化、v0.21）:
  1. Phase Introduction（3800px / 190秒 / 速度3.5）— Aurora Steppe（v0.20で延長、v0.21で速度調整）
  2. Echo Mastery（4000px / 210秒 / 速度4.0）— Crystal Expanse（v0.21で速度調整）
  3. Final Dimension（5000px / 240秒 / 速度4.5）— Volcanic Rift（v0.21で速度調整）
  4. Neon Cityscape（4500px / 220秒 / 速度5.0）— サイバーパンク都市（v0.16、v0.21で速度基準設定）
  5. Deep Ocean Trench（5500px / 260秒 / 速度5.0）— 深海海溝（v0.16）
  6. Astral Void（6000px / 280秒 / 速度5.0）— 星間終章（v0.16）
...
- `versions/v0.20/` - v0.20のアーカイブ（ゲームバランス調整版）
- `versions/v0.21/` - v0.21のアーカイブ（最新ビルド - ステージ別移動速度調整版）
